	 ...
	 var $ = require('jquery');
        ...
        $("#deleteBtn").click(function(){
         ...
         $(".delete-btn").click(function(){
			...
			if(confirm('确定要删除吗?'))
			{
				window.location.href= SITE_URL+ "adminpanel/loudongfangjian/delete_one/"+v;
			}
		});
            ...
            $('#validateform').bootstrapValidator({
				...
				$.ajax({
					type: "POST",
					url: edit?SITE_URL+"adminpanel/loudongfangjian/edit/"+id:SITE_URL+"adminpanel/loudongfangjian/add/",
